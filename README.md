...
* **[CamillaDSP](https://henquist.github.io/)** — Free, Open Source, Gratis
    * Native UI for CamillaDSP - [CamillaDSP Monitor](https://github.com/Wang-Yue/CamillaDSP-Monitor) — Free, Open Source, Gratis
...
* **[AU Lab](https://www.apple.com/apple-music/apple-digital-masters/)** — Proprietary, Gratis
    * My AU Lab [setup guide](https://github.com/cvknage/dotfiles/blob/main/equaliser/au-lab/README.md)
